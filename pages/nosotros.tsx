...
export default function nosotros() {
  return (
    <Layout
      title="Nosotros | Estudio Fotografico Perez"
      description="A que se dedica la micro empresa Estudio Fotografico Perez"
    >
      <div className="container-fluid my-5">
        <div className="row justify-content-center ">
          ...
          <div
            className={`col-md-4 ${style.margin} align-self-center text-center`}
          >
            ...
            <div className="row justify-content-center ">
              <div className="col">
                ...
                <h2>Misión</h2>
                <p>
                  Brindar un servicio completo de: calidad, profesional y
              ...
              <div className="col">
                ...
                <h2>Visión</h2>
                <p>
                  Convertirnos en una empresa consolidada en ambito de la
                  fotografía.
                </p>
              </div>
            </div>
