...
export default React.forwardRef(function Header() {
  ...
  return (
    <header>
      <nav
        className={`${styles.header} navbar navbar-expand-lg navbar-light bg-light`}
      >
        <div className="container-fluid">
          <Link href="/" passHref>
            <a className="navbar-brand d-flex align-items-center">
              <Image
                src={logo}
                alt="logo Estudio Fotografico Perez"
                width="90"
                height="90"
                className="d-inline-block align-text-top"
              />
              Estudio Fotografico Perez
            </a>
          </Link>
          <button
            ...
            <ul className="navbar-nav d-flex ">
              ...
              <li className="nav-item dropdown">
                ...
                <div className="dropdown-menu">
                  ...
                  <Link href="/servicios/cuadros" passHref>
                    <a
                      className={`dropdown-item  ${
                        router.pathname == "/servicios/cuadros" ? "active" : ""
                      } `}
                    >
                      Cuadros
                    </a>
              ...
              <li className="nav-item">
                <Link href="/nosotros" passHref>
                  <a
                    className={`nav-link ${
                      router.pathname == "/nosotros" ? "active" : ""
                    } `}
                  >
                    Nosotros
                  </a>
              ...
              <li className="nav-item">
                <Link href="/promociones" passHref>
                  <a
                    className={`nav-link ${
                      router.pathname == "/promociones" ? "active" : ""
                    } `}
                  >
                    Promociones
                  </a>
